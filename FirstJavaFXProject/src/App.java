...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        classButton.setStyle("-fx-background-color: linear-gradient(to bottom, #FFB3B3, #FF6666); -fx-background-radius: 20px; -fx-text-fill: white; -fx-font-family: 'Uni Sans'; -fx-font-size: 18px; -fx-padding: 10px 20px; -fx-effect: dropshadow(three-pass-box, rgba(0,0,0,0.3), 10, 0, 0, 0);");
        Font font = Font.loadFont(getClass().getResourceAsStream("/path/to/uni-sans-font.ttf"), 18);
      ...
      initialScene = new Scene(buttonVbox, 700, 500);
    ...
    private Scene getSeatSelectionScene(Stage primaryStage) {
        ...
        seatSelectionVbox.setPadding(new Insets(100));
        seatSelectionVbox.setSpacing(10);

        totalAmountLabel = new Label("Total Amount: $" + totalAmount);
        totalAmountLabel.setStyle("-fx-background-color: #F5F5DC;");
      ...
      startButton.setStyle("-fx-background-color: transparent; -fx-border-color: #800000; -fx-border-width: 1px; -fx-border-radius: 5px; -fx-text-fill: #f5f5f5; -fx-font-family: 'Century Gothic';");
        ...
        resetButton.setOnAction(e -> {
            ...
            primaryStage.setScene(getSeatSelectionScene(primaryStage));
            totalAmount = 0;
        ...
        // seatSelectionVbox.getChildren().addAll(totalAmountLabel, resetButton, startButton);
      ...
      BackgroundSize backgroundSize = new BackgroundSize(BackgroundSize.AUTO, BackgroundSize.AUTO, false, false, true, true);
        BackgroundImage backgroundimg = new BackgroundImage((new Image("https://u7.uidownload.com/vector/780/669/vector-movie-cinema-hall-theater-with-projection-wall-eps.jpg")), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.CENTER, backgroundSize);
      ...
      Background background = new Background(backgroundimg);  
        ...
        Scene seatSelectionScene = new Scene(parentVBox, 1000, 1000);
    ...
    firstClassGridPane.setPadding(new Insets(11));
    ...
    thirdClassGridPane.setPadding(new Insets(11));
    ...
    public Button createSeatButton(Pair<Character, Integer> seat) {
        ...
        if (seat.getFirst() == 'O') {
            seatButton.setStyle("-fx-background-color: #808080; -fx-text-fill: #FFFFFF"); // Reserved color
        } else {
            if (seatNumber <= FIRST_CLASS_ROWS * FIRST_CLASS_COLS) {
                ...
                seatButton.setStyle("-fx-background-color: #800000; -fx-text-fill: #FFFFFF"); // Second Class color
            } else {
